          ...
          <>
            ...
            <div className="flex flex-col justify-center items-center border-2 w-1/2 rounded-md gap-3 shadow-lg bg-white">
              ...
              <button
                ...
                className="border-2 w-90 p-2 rounded-lg bg-gradient-to-r from-blue-300 to-blue-500"
              >
                + Add Column
              </button>
              <br />
              ...
              <button
                ...
                className="border-2 w-60 mb-5 p-3 rounded-sm bg-blue-200 hover:bg-blue-500 hover:rounded-full transition-all duration-500"
              >
                Create Table
              </button>
            </div>
